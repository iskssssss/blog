...
public interface IBlogMapper {
     ...
     * @return 结果
     */
    int insertBlogSortInfo(@Param("aId") Long aId, @Param("sId") Long sId);
     ...
     * @return 结果
     */
    int insertBlogLabelInfo(@Param("aId") Long aId, @Param("lId") Long lId);
     ...
     * @return 分类列表
     */
    List<ArticleBasicModel> selectManagementShowInfo(@Param("page") int page, @Param("limit") int limit);
     ...
     * @return 分类列表
     */
    List<ArticleBasicModel> selectPublicShowInfo(@Param("page") int page, @Param("limit") int limit);
